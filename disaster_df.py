...
# Q1 : What does the keyword global do in the function line 109?
         # Here global keyword is allows the user to modify the variable outside of the current scope.
# Q2 : Which of the following concepts are demonstrated in implementation of the above function and why?: Overloading, Polymorphism, Recursion?
         # Recursion concept is used in this program. The function is called repeatedly to retrieve the data when the next button is pressed.
